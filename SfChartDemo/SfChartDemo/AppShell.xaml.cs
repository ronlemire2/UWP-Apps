...
using SfChartDemo.Controls;
using SfChartDemo.Views;
using System;
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    DestPage = typeof(StackedChartsPage),
                    PageToken = "StackedCharts"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Pie Charts",
                    DestPage = typeof(PieChartsPage),
                    PageToken = "Pie Charts"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Annotations",
                    DestPage = typeof(AnnotationsPage),
                    PageToken = "Annotations"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "AutoScrolling",
                    DestPage = typeof(AutoScrollingPage),
                    PageToken = "AutoScrolling"
                },
            });
