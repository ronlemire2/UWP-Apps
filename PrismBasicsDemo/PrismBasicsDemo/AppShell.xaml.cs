...
using PrismBasicsDemo.Controls;
...
namespace PrismBasicsDemo {
    ...
    public sealed partial class AppShell : Page {
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                ...
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Commanding",
                    DestPage = typeof(CommandingPage),
                    PageToken = "Commanding"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "EventAggregator",
                    DestPage = typeof(EventAggregatorPage),
                    PageToken = "EventAggregator"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Lifecycle",
                    DestPage = typeof(LifecyclePage),
                    PageToken = "Lifecycle"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Navigation",
                    DestPage = typeof(NavigationPage),
                    PageToken = "Navigation"
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.OutlineStar,
                    Label = "Validation",
                    DestPage = typeof(ValidationPage),
        ...
        public AppShell() {
            ...
            // AutoWireViewModel doesn't work with AppShell. Not sure why not. Could be why EventAggregator is not working also.
