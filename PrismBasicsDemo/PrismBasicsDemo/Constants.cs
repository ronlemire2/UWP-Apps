...
namespace PrismBasicsDemo {
    public static class Constants {
        //public const string ServerAddress = "http://localhost:9091";
        //public const string ServerAddress = "http://localhost:8083";
        //public const string ServerAddress = "http://testwebapi.azurewebsites.net/";
