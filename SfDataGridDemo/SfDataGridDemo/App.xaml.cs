...
namespace SfDataGridDemo {
    ...
    sealed partial class App : PrismUnityApplication {
        ...
        protected override void ConfigureContainer() {
            ...
            RegisterTypeIfMissing(typeof(IOrderRepository), typeof(OrderRepository), true);
            RegisterTypeIfMissing(typeof(IOrder2Repository), typeof(Order2Repository), true);
            RegisterTypeIfMissing(typeof(IEmployeeRepository), typeof(EmployeeRepository), true);
            RegisterTypeIfMissing(typeof(ISalesRepository), typeof(SalesRepository), true);
            RegisterTypeIfMissing(typeof(ICustomerRepository), typeof(CustomerRepository), true);
            ...
            RegisterTypeIfMissing(typeof(ICountryRepository), typeof(CountryRepository), true);
        }
    }
}
